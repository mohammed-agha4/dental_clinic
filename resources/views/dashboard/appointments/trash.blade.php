                        ...
                        <tbody>
                            @forelse ($appointments as $appointment)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        @can('appointments.restore')
                                            <form action="{{ route('dashboard.appointments.restore', $appointment->id) }}"
                                        ...
                                        @endcan
                                        @can('appointments.force_delete')
                                            <form action="{{ route('dashboard.appointments.force-delete', $appointment->id) }}"
                                                method="post" class="d-inline">
                                                @method('DELETE')
                                                @csrf
