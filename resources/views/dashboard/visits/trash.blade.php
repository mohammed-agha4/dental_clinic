                ...
                <table class="table table-striped table-hover small">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>{{ $v->visit_date }}</td>
                            <td>
                                <form action="{{ route('dashboard.visits.restore', $v->id) }}" method="post" class="d-inline">
                                    @method('PUT')
                                    @csrf
                                ...
                                <form action="{{ route('dashboard.visits.force-delete', $v->id) }}" method="post" class="d-inline">
                                    @method('DELETE')
                                    @csrf
