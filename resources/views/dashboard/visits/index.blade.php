                    ...
                    <tbody>
                        @forelse ($visits as $v)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a class="btn btn-outline-primary btn-sm" href="{{ route('dashboard.visits.edit', $v->id) }}">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button class="btn btn-outline-danger btn-sm delete-btn" data-id="{{ $v->id }}" data-name="{{ $v->patient->fname }}">
