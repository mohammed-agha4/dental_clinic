                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <td>
                                    <form action="{{ route('dashboard.staff.restore', $st->id) }}" method="post" class="d-inline">
                                        @method('PUT')
                                        @csrf
                                    ...
                                    <form action="{{ route('dashboard.staff.force-delete', $st->id) }}" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to permanently delete this staff?')">
