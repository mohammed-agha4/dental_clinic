<ul class="nav flex-column" id="DropdownAutoClose">
    ...
    @if (auth()->user()->can('patients.view') ||
            auth()->user()->can('appointments.view') ||
        ...
        <li class="nav-item">
            <a class="nav-link dropdown-toggle {{ request()->is('dashboard/patients*') || request()->is('dashboard/appointments*') || request()->is('dashboard/visits*') ? 'active' : '' }}"
                href="#patientCareSubmenu" data-bs-toggle="collapse" {{-- aria-expanded="{{ request()->is('dashboard/patients*') || request()->is('dashboard/appointments*') || request()->is('dashboard/visits*') ? 'true' : 'false' }}" --}}>
            ...
            <ul class="collapse list-unstyled ps-3 {{ request()->is('dashboard/patients*') || request()->is('dashboard/appointments*') || request()->is('dashboard/visits*') ? 'show' : '' }}"
                id="patientCareSubmenu" data-bs-parent="#DropdownAutoClose">
                @can('patients.view')
                    <li class="nav-item">
    ...
    @if (auth()->user()->can('services.view') ||
            ...
            auth()->user()->can('service_staff.view'))
        <li class="nav-item">
            <a class="nav-link dropdown-toggle {{ request()->is('dashboard/services*') || request()->is('dashboard/staff*') || request()->is('dashboard/service-staff*') ? 'active' : '' }}"
                href="#clinicSubmenu" data-bs-toggle="collapse" {{-- aria-expanded="{{ request()->is('dashboard/services*') || request()->is('dashboard/staff*') || request()->is('dashboard/service-staff*') ? 'true' : 'false' }}" --}}>
            ...
            <ul class="collapse list-unstyled ps-3 {{ request()->is('dashboard/services*') || request()->is('dashboard/staff*') || request()->is('dashboard/service-staff*') ? 'show' : '' }}"
                id="clinicSubmenu" data-bs-parent="#DropdownAutoClose">
                @can('services.view')
                    <li class="nav-item">
    ...
    @if (auth()->user()->can('payments.view') || auth()->user()->can('expenses.view'))
        <li class="nav-item">
            <a class="nav-link dropdown-toggle {{ request()->is('dashboard/payments*') || request()->is('dashboard/expenses*') ? 'active' : '' }}"
                href="#financeSubmenu" data-bs-toggle="collapse" {{-- aria-expanded="{{ request()->is('dashboard/payments*') || request()->is('dashboard/expenses*') ? 'true' : 'false' }}" --}}>
            ...
            <ul class="collapse list-unstyled ps-3 {{ request()->is('dashboard/payments*') || request()->is('dashboard/expenses*') ? 'show' : '' }}"
                id="financeSubmenu" data-bs-parent="#DropdownAutoClose">
                @can('payments.view')
                    <li class="nav-item">
    ...
    @if (auth()->user()->can('roles.view') || auth()->user()->can('user_roles.view'))
        <li class="nav-item">
            <a class="nav-link dropdown-toggle {{ request()->is('dashboard/roles*') || request()->is('dashboard/user-roles*') ? 'active' : '' }}"
                href="#roleSubmenu" data-bs-toggle="collapse" {{-- aria-expanded="{{ request()->is('dashboard/roles*') || request()->is('dashboard/user-roles*') ? 'true' : 'false' }}" --}}>
            ...
            <ul class="collapse list-unstyled ps-3 {{ request()->is('dashboard/roles*') || request()->is('dashboard/user-roles*') ? 'show' : '' }}"
                id="roleSubmenu" data-bs-parent="#DropdownAutoClose">
                @can('roles.view')
                    <li class="nav-item">
